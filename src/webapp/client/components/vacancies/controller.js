...
export default class VacanciesController extends BaseAngularController {

    constructor(vacancyService, $scope, $window, CONST, $rootScope, $stateParams, coreFactory, $mdDialog, $element, $http, $filter, $state) {
        super();
        this.scope = $scope;
...
VacanciesController.$inject = ['vacancyService', '$scope', '$window', 'CONST', '$rootScope', '$stateParams', 'coreFactory', '$mdDialog', '$element', '$http', '$filter', '$state'];
