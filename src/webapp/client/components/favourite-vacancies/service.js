...
class favouriteVacancyService extends BaseAngularApiService {
...
export default angular.module('services.favouriteVacancy', [])
    .service('favouriteVacancyService', favouriteVacancyService)
    .name;
