...
class trainingScanService extends BaseAngularApiService {
...
export default angular.module('services.trainingScan', [])
    .service('trainingScanService', trainingScanService)
    .name;